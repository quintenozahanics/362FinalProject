...
<form method="POST">
    <input type="text" placeholder="Enter Full Name:" name="fullName"></input>
    <br>
...
if (isset($_POST["create"])) {
    if (empty($_POST["uname"]) || empty($_POST["pass"]) || empty($_POST["fullName"])) {
        ...
        $statement2->bindParam(1, $_POST["uname"], PDO::FETCH_ASSOC);
        $statement2->execute();
        $isExisting = $statement2->fetch(PDO::FETCH_ASSOC);
        //////////////////////////////////// BUG //////////////////////////////////////
        // if check is triggering on page load ? for some reason
        if($isExisting){
